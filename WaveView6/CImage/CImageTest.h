#ifndef _CImage_Test_H_
#define _CImage_Test_H_
...
template<typename T> 
int Get_Local_Max             ( CImg<T>& img, int x0, int y0, int radius, 
                                int x1, int y1, int& lx, int& ly, float threshold);

template<typename T> 
bool SearchLocalExtrem(CImg<T>& img, int centerX, int centerY, int radius, bool bMaximum=true);

template<typename T> 
bool FindSteSize              ( CImg<T>& img, int& maxPixelX, int& maxPixelY, int& stepX, int& stepY);

template<typename T> 
bool CentroidAlongDirection   ( CImg<T>& img, CImg<T> output, int startX, int startY, int& stepX, int& stepY);

template<typename T> 
bool InterplatedLocalMax      ( CImg<T>& img, int atX, int atY, float& maxX, float& maxY);

template<typename T> 
bool InterplatedLocalMin      ( CImg<T>& img, int atX, int atY, float& minX, float& minY);
...
void SimulateImageData(int colSize, int rowSize, Point* imgBuff,
