========================================================================
    STATIC LIBRARY : LLWDataProcessor Project Overview
========================================================================

AppWizard has created this LLWDataProcessor library project for you. 

This file contains a summary of what you will find in each of the files that
make up your LLWDataProcessor application.


LLWDataProcessor.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named LLWDataProcessor.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "LLWDataProcessor.rc" and a "LLWDataProcessor.h" that 
