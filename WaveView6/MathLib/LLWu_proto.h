...
#ifndef LLW_U_PROTO_H

/* Secure against multiple inclusion */

#define LLW_U_PROTO_H
...
DllExport int newton              /* Newton method in one dimension    .........*/
           (
...
DllExport int newpoly              /* Newton method for polynomials  ...........*/
            (
...
DllExport int polval                /* Newton method for polynomials ...........*/
           (
...
DllExport int newmod              /* Modified Newton Method ....................*/
           (
            REALFCT   fct,        /* Function ........................*/
...
DllExport int pegasus             /* Pegasus Method    .........................*/
            (
             REALFCT   fct,       /* Function ........................*/
...
DllExport int roots               /* Pegasus, Anderson-Bjoerck-King method    ..*/
          (
           int       method,      /* method    .......................*/
           REALFCT   fct,         /* function ........................*/
...
DllExport int mueller             /* Mueller's method for real polynomials .....*/
            (
             int   n,             /* degree of the polynomial ........*/
...
DllExport void fmval              /* (Complex) polynomial value ................*/
           (
...
DllExport int bauhub              /* Bauhuber's method for complex polynomials .*/
           (
 ...
 *--------------------------------------------------------------------*/
//int fgauss(int n, double* vec, double* x);

DllExport int gauss            /* Gauss algorithm for solving linear equations .*/
          (
...
DllExport int gaudec              /* Gauss decomposition .......................*/
           (
...
DllExport int gausoli              /* Gauss with iterative refinement ..........*/
            (
             int     n,            /* Dimension of matrix ............*/
...
DllExport int mgauss                     /* Gauss for multiple right hand sides */
           (
...
DllExport REAL det                /* Determinant  ..............................*/
           (
            int     n,            /* Dimension of the matrix .........*/
            REAL *  mat[]         /* matrix ..........................*/
           );

DllExport int choly               /* Cholesky Method ...........................*/
          (
           int     mod,           /* Modus: 0, 1, 2 ..................*/
           int     n,             /* Dimension of matrix .............*/
           REAL *  mat[],         /* matrix ..........................*/
...
DllExport int chodec              /* Cholesky decomposition ....................*/
           (
            int     n,            /* size of matrix ..................*/
            REAL *  mat[]         /* input matrix/Cholesky factor ....*/
           );

DllExport int chosol              /* Cholesky solver ...........................*/
           (
            int     n,            /* Dimension of matrix .............*/
...
DllExport int pivot               /* Find the matrix inverse (Exchange steps) ..*/
          (
           int     n,             /* size of matrix ..................*/
           REAL *  mat[],         /* input matrix ....................*/
...
DllExport int trdiag              /* Tridiagonal linear systems ................*/
           (
...
DllExport int tzdiag              /* cyclic tridiagonal linear systems .........*/
           (
            int   n,              /* size of matrix ..................*/
...
DllExport int diag5               /* 5 diagonal linear systems .................*/
          (
           int   mod,             /* Modus: 0, 1, 2 ..................*/
           int   n,               /* size of matrix ..................*/
...
DllExport int diag5dec            /* LU factorization of a 5 diagonal matrix ...*/
             (
              int   n,            /* size of matrix  .................*/
              REAL  ld2[],        /* 2. lower co-diagonal ............*/
              REAL  ld1[],        /* 1. lower co-diagonal ............*/
...
DllExport int diag5sol            /* solve a five diagonal linear system .......*/
             (
              int   n,            /* size of matrix ..................*/
              REAL  ld2[],        /* 2. lower co-diagonal ............*/
              REAL  ld1[],        /* 1. lower co-diagonal ............*/
...
DllExport int diag5pd             /* 5 diagonal symmetric strongly nonsingular .*/
            (
             int   mod,           /* Modus: 0, 1, 2 ..................*/
             int   n,             /* # matrix rows ...................*/
             REAL  d[],           /* main diagonal ...................*/
...
DllExport int diag5pddec       /* Factor 5 diagonal strongly nonsingular matrix */
               (
                int   n,          /* # Matrix rows ...................*/
                REAL  d[],        /* main diagonal ...................*/
...
DllExport int diag5pdsol          /* Solve systems for 5 diagonal symmetric m. .*/
               (
                int   n,          /* size of matrix ..................*/
                REAL  d[],        /* main diagonal ...................*/
                REAL  ud1[],      /* 1. co-diagonal ..................*/
...
DllExport int pack                /* condense a row ............................*/
         (
          int     n,              /* size of matrix ..................*/
...
DllExport int unpack              /* uncondense row ............................*/
         (
          int     n,              /* size of matrix ..................*/
          int     ld,             /* number of lower co-diagonals ....*/
          int     ud,             /* number of upper co-diagonals ....*/
...
DllExport int band                /* Linear systems with banded matrices .......*/
         (
          int    mod,             /* Modus: 0, 1, 2 ..................*/
...
DllExport int banddec             /* Factor a banded matrix ....................*/
            (
             int    n,            /* size of system ..................*/
             int    ld,           /* # of lower co-diagonals .........*/
             int    ud,           /* # of upper co-diagonals .........*/
...
DllExport int bandsol             /* Solve a banded system .....................*/
            (
             int    n,            /* size of system ..................*/
             int    ld,           /* # of lower co-diagonals .........*/
             int    ud,           /* # of upper co-diagonals .........*/
...
DllExport int bando               /* Linear banded system without using pivots .*/
          (
          int    mod,             /* Modus: 0, 1, 2 ..................*/
          int    n,               /* size of system ..................*/
          int    ld,              /* # of lower co-diagonals .........*/
...
DllExport int banodec             /* Decompose a banded matrix .................*/
            (
             int    n,            /* size of system ..................*/
             int    ld,           /* # of lower co-diagonals .........*/
             int    ud,           /* # of upper co-diagonals .........*/
...
DllExport int banosol             /* Solve a banded system .....................*/
            (
             int    n,            /* size of system ..................*/
             int    ld,           /* # of lower co-diagonals .........*/
             int    ud,           /* # of upper co-diagonals .........*/
...
DllExport int house               /* Householder Method ........................*/
          (
           int     m,             /* # of rows .......................*/
           int     n,             /* # of columns ....................*/
           REAL *  mat[],         /* Input matrix ....................*/
...
DllExport int mhouse              /* Householder method for m right hand sides .*/
           (
            int     m,            /* # of rows .......................*/
            int     n,            /* # of columns ....................*/
...
DllExport REAL hcond              /* Hadamard condition number .................*/
             (
              int     n,          /* size of matrix ..................*/
              REAL *  mat[]       /* matrix ..........................*/
             );

DllExport REAL ccond              /* Conditions estimate according to Cline ....*/
             (
              int     n,          /* Dimension of matrix .............*/
              REAL *  mat[]       /* matrix ..........................*/
             );

DllExport REAL fcond              /* Condition estimate of Forsythe/Moler ......*/
             (
              int     n,          /* Dimension of matrix .............*/
              REAL *  mat[]       /* matrix ..........................*/
             );
...
DllExport int seidel              /* Gauss Seidel Method with relaxation .......*/
           (
...
DllExport int newt                 /* Multidimensional Newton method ...........*/
         (
          int       n,            /* size of system ..................*/
...
DllExport int mises               /* Vector iteration for max modulus eigenvalue*/
          (
           int     n,             /* Dimension of matrix .............*/
           REAL *  mat[],         /* matrix ..........................*/
           REAL    x[],           /* Eigenvector .....................*/
...
DllExport int eigen               /* Compute all evalues/evectors of a matrix ..*/
          (
